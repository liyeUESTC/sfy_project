...
ReturnStatus FileOperation::Write(const char *buf_ptr,int write_size,off_t offset,
    int whence)
{
...
ReturnStatus FileOperation::Read(char *buf_ptr,int read_size,off_t offset,
    int whence)
{
